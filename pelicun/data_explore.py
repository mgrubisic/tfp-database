...
fig = plt.figure()
ax = plt.scatter(df_plot['gapRatio'], df_plot['max_drift'], alpha=0.5)
plt.title('Gap and max drift')
plt.xlabel('Gap ratio')
plt.ylabel('Max drift [PID%]')
plt.grid(True)

fig = plt.figure()
ax = plt.scatter(df_plot['gapRatio'], df_plot['collapse_freq'], alpha=0.5)
...
fig = plt.figure()
ax = plt.scatter(df_plot['RI'], df_plot['collapse_freq'], alpha=0.5)
